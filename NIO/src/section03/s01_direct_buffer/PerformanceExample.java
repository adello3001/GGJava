package section03.s01_direct_buffer;
...
public class PerformanceExample {
	public static void main(String[] args) throws Exception {
		Path from = Paths.get("src/section03/s01_direct_buffer/house.jpg");
		Path to1 = Paths.get("src/section03/s01_direct_buffer/house2.jpg");
		Path to2 = Paths.get("src/section03/s01_direct_buffer/house3.jpg");
